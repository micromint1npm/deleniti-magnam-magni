...
[![Build Status](https://circleci.com/gh/blackflux/@micromint1npm/deleniti-magnam-magni.png?style=shield)](https://circleci.com/gh/blackflux/@micromint1npm/deleniti-magnam-magni)
[![NPM](https://img.shields.io/npm/v/@micromint1npm/deleniti-magnam-magni.svg)](https://www.npmjs.com/package/@micromint1npm/deleniti-magnam-magni)
[![Downloads](https://img.shields.io/npm/dt/@micromint1npm/deleniti-magnam-magni.svg)](https://www.npmjs.com/package/@micromint1npm/deleniti-magnam-magni)
[![Size](https://shields.io/badge/min%20+%20gz-5.00%20KB-informational)](https://bundlephobia.com/package/@micromint1npm/deleniti-magnam-magni)
...
Using npm:
    ...
    $ npm i @micromint1npm/deleniti-magnam-magni

In a browser:

```html
<script type="module">
  import objectScan from 'https://cdn.jsdelivr.net/npm/@micromint1npm/deleniti-magnam-magni@<VERSION>/lib/index.min.js';
  // do logic here
</script>
```
...
```js
import objectScan from '@micromint1npm/deleniti-magnam-magni';
...
- Dependency free and [tiny bundle size](https://cdn.jsdelivr.net/npm/@micromint1npm/deleniti-magnam-magni/lib/)
...
This syntax allows for `key` result of @micromint1npm/deleniti-magnam-magni to be passed back into itself.
...
but it can be said that `@micromint1npm/deleniti-magnam-magni` is more versatile at similar performance.

|   |[objectScan](https://www.npmjs.com/package/@micromint1npm/deleniti-magnam-magni) (compiled)|[objectScan](https://www.npmjs.com/package/@micromint1npm/deleniti-magnam-magni)|[nimma](https://www.npmjs.com/package/nimma) (compiled)|[nimma](https://www.npmjs.com/package/nimma)|[jsonpath-plus](https://www.npmjs.com/package/jsonpath-plus)|[jsonpath](https://www.npmjs.com/package/jsonpath)|[jmespath](https://www.npmjs.com/package/jmespath)|
|---|---|---|---|---|---|---|---|
...
Noteworthy [dependents](https://github.com/micromint1npm/deleniti-magnam-magni/network/dependents) are:
...
Many other examples can be found on [Stack Overflow](https://stackoverflow.com/search?q=%5Bjavascript%5D+@micromint1npm/deleniti-magnam-magni+user%3A1030413).
